...
export const addTypeOfMeasure = (data: { name: string }) => api.post('/TypeOfMeasure', data);
export const updateTypeOfMeasure = (id: number, data: { name: string }) => api.put(`/TypeOfMeasure/${id}`, data);
