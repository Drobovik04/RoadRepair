...
export const getRepairEventsByRepairZoneId = (id: number) => api.get<RepairEvent[]>(`/RepairEvent/repairZone/${id}`);
export const getRepairEventsByWorkAreaId = (id: number) => api.get<RepairEvent[]>(`/RepairEvent/workArea/${id}`);
