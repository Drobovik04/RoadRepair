...
namespace RoadRepair.Tests.Database
{
    ...
    public abstract class TestDbContextFixture
    {
        protected DbContextOptions<TestDbContext> CreateNewContextOptions()
        {
        ...
        protected TestDbContext CreateContext() => new TestDbContext(CreateNewContextOptions());
    }
}
